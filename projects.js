...
export const projectsData = [
  {
    ...
    // 作品概要
    overview: "学校生活における課題や提出物の数が多く、管理の煩雑さや締切の抜け漏れを防ぐために開発した一元管理アプリケーション。",
  ...
  },
  {
    ...
    // 作品概要
    overview: "IT専門学校での日々の学習成果、習熟度スキルレベル、制作物、資格を一元管理し、就職活動時の自己PRや成長分析に役立てるアプリケーション。",

    // 課題背景
    problems: [
      "ITの専門学校で勉強していると「自分は何ができるようになったんだろう？」と成長を実感しづらい",
